...
class FakeOpenArmV10HW : public hardware_interface::SystemInterface {
 public:
  FakeOpenArmV10HW();
 ...
 private:
  ...
  // Default PD gains (same as V10 real hardware defaults)
  ...
  // Generated joint names
  std::vector<std::string> joint_names_;

  // Command and state vectors
